  ...
  return (
    <article className="bc" style={{ background: "#fff", borderRadius: "14px", border: `2px solid ${isF ? "#e74c3c" : isV ? "#27ae60" : "#e8e0d0"}`, overflow: "hidden", boxShadow: "0 2px 8px rgba(0,0,0,0.06)", position: "relative" }}>
      ...
      <div style={{ padding: "0.9rem 1rem 0.75rem" }}>
        ...
        {/* INFO VISITA DO TIME, RATING E TEMPERATURA - PROPOSTA 2: DIVERTIDO E VIBRANTE */}
        <div style={{ 
          display: "flex", 
          justifyContent: "space-between", 
          alignItems: "center", 
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "5px", flexShrink: 0 }}>
            {hasVisitedByParticipants ? (
              ...
              <>
                <span style={{ fontSize: "0.72rem", fontFamily: "sans-serif", color: "#bbb" }}>⏳</span>
                <span style={{ 
                  fontSize: "0.72rem", 
                  fontFamily: "sans-serif", 
                  color: "#bbb",
          ...
          {/* Nota do time - Fundo amarelo vibrante com texto escuro */}
          {hasRating && (
            <div style={{ 
              display: "flex", 
              alignItems: "center", 
          ...
          {/* Temperatura da cerveja - Fundo colorido vibrante por temperatura */}
          {hasBeerTemp && (
            <div style={{ 
              display: "flex", 
              alignItems: "center", 
